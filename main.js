...
(function() {
	...
	btnSavePull.onclick = function(e) {
		...
		inputFluffyLevel.value = Math.min(Number(Math.floor(Math.log(((game.global.fluffyExp / (1000 * Math.pow(5, game.global.fluffyPrestige))) * 3) + 1) / Math.log(4)))), Number(game.portal.Capable.level);
